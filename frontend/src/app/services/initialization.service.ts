...
export class InitializationService {
    ...
    init() {
        ...
        let appointment2 = new Appointment("2", appointmentType2._id, doctor2._id, patient2._id, "Bol u stomaku.", new Date())
        let appointment3 = new Appointment("3", appointmentType3._id, doctor3._id, patient3._id, "Bol u stomaku.", new Date())
        let appointment4 = new Appointment("4", appointmentType4._id, doctor4._id, patient1._id, "Bol u stomaku.", new Date())
