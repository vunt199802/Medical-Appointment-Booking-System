...
export class InitializationService {
  ...
  init() {
    ...
    //  ============= Specialization ==================
    let specialization1 = new Specialization("Oftamologija");
    let specialization2 = new Specialization("Kardiologija");
    let specialization3 = new Specialization("Radiologija");
    let specialization4 = new Specialization("Pedijatrija");
    let specialization5 = new Specialization("Hirurgija");
    let specialization6 = new Specialization("Neurolgija");
    let specialization7 = new Specialization("Anesteziologija");
    ...
    //  ============= Patients ==================
    let patient1 = new Patient("Jelica", "Cincović", "patient1", "patient1", true, "Rankeova 16, Novi Sad", "123456", "patient1@gmail.com", defaultImage)
    let patient2 = new Patient("Aleksandar", "Vasilić", "patient2", "patient2", true, "Rankeova 16, Novi Sad", "123456", "patient2@gmail.com", defaultImage)
    let patient3 = new Patient("Dragan", "Bojić", "patient3", "patient3", true, "Rankeova 16, Novi Sad", "123456", "patient3@gmail.com", defaultImage)
    let patient4 = new Patient("Adrian", "Milaković", "patient4", "patient4", false, "Rankeova 16, Novi Sad", "123456", "patient4@gmail.com", defaultImage)
    let patient5 = new Patient("Filip", "Hadžić", "patient5", "patient5", false, "Rankeova 16, Novi Sad", "123456", "patient5@gmail.com", defaultImage)
    ...
    //  ============= Doctors ==================
    let doctor1 = new Doctor("doctor1", "lastname1", "doctor1", "doctor1", "0123456789", true, "Rankeova 16, Novi Sad", "doctor1@gmail.com", defaultImage, "0123456799", specialization1._id, specialization1._id);
    let doctor2 = new Doctor("doctor2", "lastname2", "doctor2", "doctor2", "0123456789", true, "Rankeova 16, Novi Sad", "doctor2@gmail.com", defaultImage, "8012345673", specialization2._id, specialization2._id);
    ...
    let notification1 = new Notification(patient1._id, false, "Notifikacija 1", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
    let notification2 = new Notification(patient2._id, false, "Notifikacija 2", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
    let notification3 = new Notification(patient3._id, false, "Notifikacija 3", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
    let notification4 = new Notification(patient1._id, true, "Notifikacija 4", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
    let notification5 = new Notification(patient2._id, true, "Notifikacija 5", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
    let notification6 = new Notification(patient3._id, true, "Notifikacija 6", "faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus quis varius quam quisque id diam vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis tristique")
