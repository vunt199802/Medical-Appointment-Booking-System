...
export class InitializationService {
    ...
    init() {
        ...
        //  ============= AppointmentType ==================
        let appointmentType1 = new AppointmentType("Ultrazvuk srca (Ehokardiografija)", "Ehokardiografija ", "(ultrazvuk srca) – pregled kojim se procenjuje izgled srca, njegova veličina, stanje srčanog mišića, promene na srčanim zaliscima, širina aorte, prisustvo tečnosti u srčanoj maramici. Daje mnoštvo informacija kako o izgledu srca, tako i o njegovom radu. Izuzetno je važan pregled i treba ga primeniti makar jedanput godišnje.", specialization1._id, ["doctorDR1", "doctorDR2"], 4000, true)
        let appointmentType2 = new AppointmentType("Ultrazvuk vrata", "Ultrazvuk vrata ", "(štitasta žlezda, pljuvačne žlezde, limfne žlezde, krvni sudovi vrata) služi za procenu stanja ovih organa i krvnih sudova. Preporučuje se pacijentima koji imaju zdravstvene tegobe, kao i zdravim ljudima radi kontrole.", specialization2._id, ["doctorDR2", "doctorDR3"], 7000, true)
        let appointmentType3 = new AppointmentType("Ultrazvuk abdomena", "Ultrazvuk abdomena ", "(jetra, žučna kesa, pankreas, slezina, bubrezi, nadbubrežne žlezde, mokraćna bešika, prostata, materica, jajnici, limfne žlezde, aorta, krvni sudovi abdomena) služi za procenu stanja ovih organa i krvnih sudova. Preporučuje se pacijentima koji imaju zdravstvene tegobe, kao i zdravim ljudima radi kontrole.", specialization3._id, ["doctorDR3"], 9000, true)
        ...
        let appointmentType7 = new AppointmentType("Ultrazvuk šake", "Ultrazvuk šake", "(vrata, glave, ruku, nogu, bubrežnih arterija, krvnih sudova jetre, aorte) služi da se proceni stanje krvnih sudova, tj. njihova širina, prisustvo suženja, prisustvo plaka, stanje zida krvnog suda. Preporučuje se pacijentima koji imaju zdravstvene tegobe, kao i zdravim ljudima radi kontrole.", specialization7._id, ["doctorDR5"], 12000, false)
