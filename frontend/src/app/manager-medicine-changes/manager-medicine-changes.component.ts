...
export class ManagerMedicineChangesComponent implements OnInit {
  ...
  updateAppointmentType(appointment) {
    ...
    this.serviceAppointmentType.update(appointment).subscribe((appNew: Appointment) => {
      this.ngOnInit()
    })
  }
  ...
  addSpecialization() {
    ...
    this.serviceSpecialization.create(specialization).subscribe((specialization: Specialization) => {
      this.ngOnInit()
    })
  }
  ...
  addAppointmentType() {
    ...
    this.serviceAppointmentType.create(this.newAppointmentType).subscribe((appointmentType: AppointmentType) => {
      this.ngOnInit()
    })
  }
}
